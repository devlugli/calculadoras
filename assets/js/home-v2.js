const homeTools = [
  ...
  { name: "Calculadora de Regra de Três Composta", url: "./calculadora-regra-de-tres-composta/", category: "Matemática", aliases: ["regra de tres composta", "regra de 3 composta", "proporcao composta"] },
  ...
  { name: "Calculadora de Raiz Quadrada", url: "./calculadora-raiz-quadrada/", category: "Matemática", aliases: ["raiz quadrada", "sqrt", "calcular raiz quadrada"] },
  { name: "Calculadora de Potência", url: "./calculadora-potencia/", category: "Matemática", aliases: ["potencia", "potência", "base e expoente"] },
  { name: "Calculadora de Perímetro", url: "./calculadora-perimetro/", category: "Matemática", aliases: ["perimetro", "perímetro"] },
  { name: "Calculadora de Volume", url: "./calculadora-volume/", category: "Matemática", aliases: ["volume", "cubo", "cilindro", "caixa retangular"] },
  { name: "Calculadora de Área do Retângulo", url: "./calculadora-area-do-retangulo/", category: "Matemática", aliases: ["area do retangulo", "área do retângulo"] },
  { name: "Calculadora de Área do Triângulo", url: "./calculadora-area-do-triangulo/", category: "Matemática", aliases: ["area do triangulo", "área do triângulo"] },
  { name: "Calculadora de Área do Trapézio", url: "./calculadora-area-do-trapezio/", category: "Matemática", aliases: ["area do trapezio", "área do trapézio"] },
  ...
  { name: "Calculadora de Rendimento da Poupança", url: "./calculadora-rendimento-poupanca/", category: "Finanças", aliases: ["rendimento poupanca", "rendimento da poupança", "quanto rende poupanca"] },
  ...
  { name: "Calculadora de Reajuste de Aluguel", url: "./calculadora-reajuste-de-aluguel/", category: "Finanças", aliases: ["reajuste de aluguel", "novo aluguel", "calcular reajuste aluguel"] },
  ...
  { name: "Calculadora de Juros de Mora e Multa", url: "./calculadora-juros-de-mora-e-multa/", category: "Finanças", aliases: ["juros de mora", "multa por atraso", "calcular atraso boleto"] },
  ...
  { name: "Calculadora de Aviso-Prévio", url: "./calculadora-aviso-previo/", category: "Trabalho e RH", aliases: ["aviso previo", "aviso-prévio", "calcular aviso previo"] },
  { name: "Calculadora de Salário-Maternidade", url: "./calculadora-salario-maternidade/", category: "Trabalho e RH", aliases: ["salario maternidade", "salário-maternidade", "beneficio maternidade"] },
  ...
  { name: "Calculadora de Consumo de Energia Elétrica", url: "./calculadora-consumo-de-energia-eletrica/", category: "Cotidiano", aliases: ["consumo energia eletrica", "consumo energia", "kwh aparelho"] },
  ...
  { name: "Calculadora de Conversão de Medidas", url: "./calculadora-conversao-de-medidas/", category: "Conversores", aliases: ["conversao de medidas", "conversão de medidas", "converter medidas", "converter unidades"] },
  { name: "Calculadora de Custo do Frete por Pedido", url: "./calculadora-custo-do-frete-por-pedido/", category: "Finanças", aliases: ["custo do frete por pedido", "frete por pedido", "custo frete"] },
  { name: "Calculadora de Preço com Taxa de Maquininha", url: "./calculadora-preco-com-taxa-de-maquininha/", category: "Finanças", aliases: ["taxa de maquininha", "preco com taxa da maquina", "valor liquido maquininha"] },
